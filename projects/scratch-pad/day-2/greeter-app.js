...
// creating an if else statement to print a string to the console depending on logic 
if(hour >= 0 && hour <= 11){ // if input number is greater than or equal to 0 and less than or equal to 11 
    console.log("Good Morning!");// print "Good Morning"
} else if (hour >= 12 && hour <= 16){// if input number is greater than or equal to 12 and less than or equal to 16
    console.log("Good Afternoon!"); // print "Good Afternoon!"
} else if (hour >= 17 && hour <= 21){// if input number is greater than or equal to 17 and less than or equal to 22
    console.log("Good Evening!");// print Good Evening to the console 
} else{
    console.log("Good Night!"); // if logic above not executed print Good Night!
}
